...
contract('Constructor', (accounts) => {
  ...
  it('should rawRegister initial words', async () => {
    let _list = ['root']
    for (let _str of _list) {
      let _owner = await ethername.ownerOf(_str)
...
contract('_rawRegister', (accounts) => {
  ...
  describe('rawRegister', () => {
    ...
    it('should work without donation', async () => {
      ...
      let _res = await ethername.rawRegister(strToBytes(_name),
        {
          from: _sender
        }
      )
    ...
    it('should work with donation', async () => {
      ...
      let _name = 'rawregisterwithdonation'
      let _sender = accounts[1]

      await ethername.rawRegister(strToBytes(_name),
        {
          from: accounts[1],
          value: _val
        }
  ...
  describe('validation', () => {
    ...
    it('should accept only alphabet lowercase and number', async () => {
      ...
      try {
        await ethername.rawRegister(web3.fromAscii(_av69WithDot),
          {
            from: accounts[1]
          }
        )
      ...
      await ethername.rawRegister(web3.fromAscii(_aTo5),
        {
          from: accounts[1]
        }
      )
      ...
      await ethername.rawRegister(web3.fromAscii(_6v),
        {
          from: accounts[1]
        }
      )
...
contract('wiper', (accounts) => {
  ...
  before(async () => {
    ethername = await Ethername.deployed()
    await ethername.rawRegister(strToBytes(name),
      {
        from: owner
      }
    )
    ...
    // approve
    await ethername.rawApprove(approved, strToBytes(name),
      {
        from: owner
      }
    )
    ...
    // attribute
    await ethername.rawSetAttribute(web3.fromAscii(name), 'page', '0x59',
      {
        from: owner
      }
    )
  ...
  it('rawTransfer should wipe all except for attrs', async () => {
    await ethername.rawTransfer(receiver, web3.fromAscii(name),
      {
        from: owner
      }
    )
...
contract('rawTransfer', (accounts) => {
  ...
  before(async () => {
    ethername = await Ethername.deployed()
    await ethername.rawRegister(web3.fromAscii(name),
      {
        from: owner
      }
    )
  ...
  it('should work if owner', async () => {
    ...
    let _res = await ethername.rawTransfer(_receiver, web3.fromAscii(name),
      {
        from: owner
      }
    )
  ...
  it('should not work unless owner', async () => {
    ...
    try {
      await ethername.rawTransfer(_receiver, strToBytes(_name),
        {
          from: _sender
        }
      )
...
contract('approve', (accounts) => {
  ...
  it('should work if owner', async () => {
    ...
    let _res = await ethername.rawApprove(_receiver, web3.fromAscii(name),
      {
        from: owner
      }
    )
  ...
  it('should not work unless owner', async () => {
    ...
    try {
      await ethername.rawApprove(_receiver, web3.fromAscii(name),
        {
          from: _sender
        }
      )
...
contract('rawTransferFrom', (accounts) => {
  ...
  before(async () => {
    ...
    await ethername.rawApprove(approved, web3.fromAscii(name),
      {
        from: owner
      }
    )
  ...
  it('should not work unless approved', async () => {
    ...
    try {
      await ethername.rawTransferFrom(owner, _receiver, web3.fromAscii(name),
        {
          from: _sender
        }
      )
  ...
  it('should work by approved', async () => {
    ...
    let _res = await ethername.rawTransferFrom(owner, _receiver, web3.fromAscii(name),
      {
        from: approved
      }
    )
...
contract('rawSetPrice', (accounts) => {
  ...
  it('should work if owner', async () => {
    ...
    let _res = await ethername.rawSetPrice(strToBytes(name), _price,
      {
        from: owner
      }
    )
  ...
  it('should not work unless owner', async () => {
    ...
    try {
      await ethername.rawSetPrice(strToBytes(name), _price,
        {
          from: _sender
        }
      )
  ...
  it('should work only if less than 2^128', async () => {
    ...
    let _res = await ethername.rawDetailsOf(strToBytes(name), '0x00')
...
contract('rawBuy', (accounts) => {
  ...
  before(async () => {
    ...
    await ethername.rawSetPrice(name, price,
      {
        from: owner
      }
    )
  ...
  it('should work with enough ether', async () => {
    ...
    let _res = await ethername.rawBuy(name,
      {
        from: _buyer,
        value: _ether
      }
...
contract('buy should not work', (accounts) => {
  ...
  it('if price is zero', async () => {
    ...
    let _buyer = accounts[2]
    await ethername.rawSetPrice(name, 0,
      {
        from: owner
      }
    )
...
contract('rawUseName', (accounts) => {
  ...
  before(async () => {
    ...
    await ethername.rawRegister(web3.fromAscii(otherName),
      {
        from: other
      }
    )
  ...
  it('should work if owner', async () => {
    ...
    let _res = await ethername.rawUseName(web3.fromAscii(names[_index]),
      {
        from: owner
      }
    )
  ...
  it('should not work unless owner', async () => {
    try {
      await ethername.rawUseName(web3.fromAscii(otherName),
        {
          from: owner
        }
      )
...
contract('rawSetAttribute', (accounts) => {
  ...
  it('should work if owner', async () => {
    ...
    let _res = await ethername.rawSetAttribute(web3.fromAscii(name), '0x00', '0x59',
      {
        from: owner
      }
    )
    ...
    _res = await ethername.rawSetAttribute(
      web3.fromAscii(name),
      web3.fromAscii(_key),
  ...
  it('should not work unless owner', async () => {
    ...
    try {
      await ethername.rawSetAttribute(web3.fromAscii(name), '0x00', '0x87',
        {
          from: _sender
        }
      )
...
contract('rawSendEther', (accounts) => {
  ...
  before(async () => {
    ...
    for (let _valid of validNames) {
      await ethername.rawRegister(web3.fromAscii(_valid.name),
        {
          from: _valid.owner
        }
      )
  ...
  it('should work', async () => {
    ...
    for (let _valid of validNames) {
      ...
      let _res = await ethername.rawSendEther(strToBytes(_valid.name),
        {
          from: accounts[0],
          value: _val
        }
  ...
  it('should not work with wrong name', async () => {
    ...
    for (let _invalidName of invalidNames) {
      try {
        let _res = await ethername.rawSendEther.call(bytesToStr(_invalidName),
          {
            from: accounts[0],
